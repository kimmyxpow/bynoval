    ...
    <div class="inner">
        <div class="mx-auto max-w-2xl">
            <div class="flex flex-col items-center justify-center gap-6 text-center">
                <span class="font-handwriting text-2xl text-zinc-400">A little context, if you’re curious </span>
    ...
    <div class="inner">
        <div class="grid grid-cols-2 gap-10">
            <div class="prose prose-invert prose-lg prose-zinc max-w-none">
                <h2>Short Bio</h2>
                <p>
                    I’m a fullstack developer, though most of my work leans toward the frontend — partly because I enjoy shaping how things look and
                    feel. Outside of building, I help run a programming community where I spend time connecting people and ideas.
                </p>
                <p>
                    I often find myself chasing new project ideas — not all of them make it to the finish line, but each one teaches me something. I
                    write to process my thoughts, read to feed them, and most days, I’m happiest in quiet spaces, working on something at my own pace.
                </p>
            </div>
            ...
            <div class="grid grid-cols-2 gap-px bg-radial from-cyan-500 to-transparent to-90% p-px">
                <div class="flex flex-col items-start bg-black px-8 py-8">
                    ...
                    <p class="text-zinc-400">
                        I design and build user-facing features, mostly focusing on clean UI and accessible interactions. Still learning new things
                        daily.
                    </p>
                ...
                <div class="flex flex-col items-start bg-black px-8 py-8">
                    <img class="h-10" src="https://zicare.id/upload/website/logo_header.svg" alt="Zi.Care Logo" />
                    <h3 class="mt-4 mb-2 text-xl font-bold">Full-Stack Developer</h3>
                    <p class="text-zinc-400">
                        Designed and built internal systems for hospitals — from back-office tools to full info systems — using PHP, Phalcon,
                ...
                <div class="flex flex-col items-start bg-black px-8 py-8">
                    <img class="h-10" src="https://www.lskk.co.id/wp-content/uploads/2024/06/Artboard-5@300x-e1718107755849.png" alt="Zi.Care Logo" />
                    <h3 class="mt-4 mb-2 text-xl font-bold">Full-Stack Developer Intern</h3>
                    <p class="text-zinc-400">
                        Built school-specific web apps — including RFID-based attendance, meeting management, and a custom site — using Next.js,
                        Tailwind, Express, and MongoDB. Also taught sessions on Flutter and IoT as a guest instructor.
                    </p>
                    <div class="mt-auto flex w-full items-center justify-between pt-4">
                ...
                <div class="flex flex-col items-start bg-black px-8 py-8">
                    ...
                    <p class="text-zinc-400">
                        Created learning materials and website templates for HTML & CSS. Built Bellshade CSS framework with SCSS and helped review
                        community submissions. Also contributed to the OpenSeries platform.
                    </p>
                    <div class="mt-auto flex w-full items-center justify-between pt-4">
                ...
                <div class="flex flex-col items-start bg-black px-8 py-8">
                    ...
                    <p class="text-zinc-400">
                        Helped manage a 50K+ member dev community — answering programming questions, maintaining a supportive vibe, and hosting
                        occasional webinars to share what I know (and learn in return).
                    </p>
                    <div class="mt-auto flex w-full items-center justify-between pt-4">
                ...
                <div class="flex flex-col items-center justify-center bg-black p-8">
                    <span class="bg-gradient-to-tr from-cyan-500 to-zinc-200 bg-clip-text text-center text-3xl text-transparent">
            ...
            <div class="relative grid">
                {#each commits as commit (commit.sha)}
                    <div class="relative pl-10 not-last:pb-4">
                        <div class="absolute top-6 -bottom-2 left-2.5 w-1 bg-gradient-to-b from-zinc-800 to-cyan-500"></div>
                        <div class="absolute top-1 left-0 size-6 rounded-full bg-gradient-to-b from-cyan-500 to-zinc-800"></div>
                        <div class="mb-1 flex items-center justify-between">
                            <span class="text-sm font-bold text-zinc-400">sha: {commit.sha}</span>
                            <span class="text-sm text-zinc-200">Changed by: <span class="font-bold">{commit.commit.committer.name}</span></span>
                        </div>
                        <div class="flex items-center justify-between">
                            <span class="bg-gradient-to-tr from-cyan-500 to-zinc-200 bg-clip-text text-xl text-transparent">
                        ...
                        <span class="text-sm text-zinc-500">
                            {formatDistance(subDays(commit.commit.committer.date, 3), new Date(), { addSuffix: true })}
                        </span>
                    </div>
                {/each}
                <div class="pointer-events-none absolute -bottom-2 h-[80%] w-full bg-gradient-to-b from-transparent to-zinc-950"></div>
            </div>
            <a
