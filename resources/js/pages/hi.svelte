                ...
                <Popover.Portal>
                    ...
                    >
                        <div class="grid gap-2">
                            ...
                            >
                                <div class="mt-1 grid size-10 shrink-0 place-items-center rounded-lg bg-amber-600 text-zinc-200">
                                    <Icon class="size-6" icon="solar:notes-linear" />
                                </div>
                                <div>
                                    <span class="text-zinc-200">Article</span>
                                    <p class="text-sm text-zinc-400">
                                        Lorem, ipsum dolor sit amet consectetur adipisicing elit. Eius ea perspiciatis voluptate minus.
                                    </p>
                                </div>
                            </a>
                            <a
                                ...
                                class="flex items-start gap-4 rounded-lg border border-zinc-700 p-4 font-medium transition-all select-none hover:bg-zinc-800 focus-visible:outline-none"
                            >
                                <div class="mt-1 grid size-10 shrink-0 place-items-center rounded-lg bg-fuchsia-600 text-zinc-200">
                                    <Icon class="size-6" icon="solar:paperclip-rounded-linear" />
                                </div>
                                <div>
                                    <span class="text-zinc-200">Snippets</span>
                                    <p class="text-sm text-zinc-400">
                                        Lorem, ipsum dolor sit amet consectetur adipisicing elit. Eius ea perspiciatis voluptate minus.
                                    </p>
                                </div>
                            ...
                            <a
                                ...
                                class="flex items-start gap-4 rounded-lg border border-zinc-700 p-4 font-medium transition-all select-none hover:bg-zinc-800 focus-visible:outline-none"
                            >
                                <div class="mt-1 grid size-10 shrink-0 place-items-center rounded-lg bg-emerald-600 text-zinc-200">
                                    <Icon class="size-6" icon="solar:paw-linear" />
                                </div>
                                <div>
                                    <span class="text-zinc-200">Guest Book</span>
                                    <p class="text-sm text-zinc-400">
                                        Lorem, ipsum dolor sit amet consectetur adipisicing elit. Eius ea perspiciatis voluptate minus.
                                    </p>
                                </div>
                ...
                <Popover.Portal>
                    ...
                    >
                        <div class="grid grid-cols-2 gap-2">
                            ...
                            >
                                <img class="size-6" src="/assets/animated-icons/about.webp" alt="About Icon" />
                                About
                            </a>
                            <a
                                href="/about"
                                class="flex h-12 items-center gap-2 rounded-lg border border-zinc-700 px-3 font-medium text-zinc-400 transition-all select-none hover:text-zinc-200 focus-visible:outline-none"
                            >
                                <img class="size-6" src="/assets/animated-icons/goals.webp" alt="Goals Icon" />
                                Goals
                            </a>
                            <a
                                href="/about"
                                class="flex h-12 items-center gap-2 rounded-lg border border-zinc-700 px-3 font-medium text-zinc-400 transition-all select-none hover:text-zinc-200 focus-visible:outline-none"
                            >
                                <img class="size-6" src="/assets/animated-icons/interest.webp" alt="Interest Icon" />
                                Interest
                            </a>
                            <a
                                href="/about"
                                class="flex h-12 items-center gap-2 rounded-lg border border-zinc-700 px-3 font-medium text-zinc-400 transition-all select-none hover:text-zinc-200 focus-visible:outline-none"
                            >
                                <img class="size-6" src="/assets/animated-icons/gallery.webp" alt="Gallery Icon" />
                                Gallery
                            </a>
                        </div>
                    </Popover.Content>
                ...
                <Popover.Portal>
                    ...
                    >
                        <div class="grid gap-2">
                            ...
                            >
                                <Icon icon="solar:call-chat-rounded-linear" class="size-6" />
                                Mentoring
                            </a>
                            <a
                                href="/about"
                                class="flex h-12 items-center gap-2 rounded-lg border border-zinc-700 px-3 font-medium text-zinc-400 transition-all select-none hover:bg-zinc-800 focus-visible:outline-none"
                            >
                                <Icon icon="solar:accessibility-linear" class="size-6" />
                                Attribution
                            </a>
                            <a
                                href="/about"
                                class="flex h-12 items-center gap-2 rounded-lg border border-zinc-700 px-3 font-medium text-zinc-400 transition-all select-none hover:bg-zinc-800 focus-visible:outline-none"
                            >
                                <Icon icon="radix-icons:discord-logo" class="size-6" />
                                Community
                            </a>
                        </div>
                    </Popover.Content>
                        ...
                        <div class="relative">
                            ...
                            >
                                <div class="relative grid place-items-center">
                                    ...
                                    <span class="textcyan500 absolute size-3 animate-ping rounded-full bg-cyan-500"></span>
                                </div>
                                Open for Opportunities
                            </span>
                            <a
                                href="/contact"
                                class="font-handwriting absolute right-0 bottom-0 translate-1/2 -rotate-4 animate-bounce text-xl text-zinc-400 hover:underline"
                            >
