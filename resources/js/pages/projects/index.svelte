...
<script lang="ts">
    ...
    const updateQuery = useDebounce(
        () => {
            router.get(route('projects.index'), selectedFilters as {}, {
                preserveState: true,
                only: ['filters'],
            });
        },
    ...
    <div class="inner">
        <div class="mx-auto max-w-2xl">
            <div class="flex flex-col items-center justify-center gap-6 text-center">
                ...
                <p class="text-lg">
                    Not every idea becomes a masterpiece — but some are worth building anyway. Here’s a mix of things I’ve shipped, tweaked, or just
