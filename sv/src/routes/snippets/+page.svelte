				...
				<div class="group relative mb-28 rounded-lg bg-zinc-900 transition-all hover:-rotate-2">
					...
					<div class="relative z-10 bg-zinc-900">
						<div class="flex flex-col space-y-4 p-6">
							...
							<p class="">
								Lorem ipsum dolor sit amet consectetur, adipisicing elit. Quae illo laudantium
								tenetur expedita dolorum debitis quod voluptates. Quae aut iste totam maxime,
								temporibus veniam, harum accusamus ad possimus cum neque, sint ullam obcaecati fugit
								ipsum similique optio iusto pariatur tempore omnis nobis quisquam laboriosam vero
								sed. Suscipit quis ducimus officia molestias porro quibusdam hic repudiandae
								laudantium atque dolores culpa sint aliquid odio ipsum quae, architecto sed,
								explicabo asperiores. Non fuga nisi inventore vel unde sequi veniam nihil excepturi
								assumenda. Corrupti necessitatibus, magnam soluta debitis fuga libero omnis quo
								saepe architecto dolore autem voluptatum, modi quibusdam reprehenderit cum dicta
								facilis similique.
							</p>
				...
				<div class="group relative mb-28 rounded-lg bg-zinc-900 transition-all hover:-rotate-2">
					...
					<div class="relative z-10 bg-zinc-900">
						<div class="flex flex-col space-y-4 p-6">
							<span class="font-handwriting text-4xl text-zinc-400">Web Project</span>
							<p class="">
								Lorem ipsum dolor sit amet consectetur, adipisicing elit. Impedit non earum,
								voluptates explicabo atque dignissimos optio vitae eligendi ex. Tempora, blanditiis
								molestiae laborum fuga debitis corrupti inventore facere saepe a.
							</p>
							<HighlightAuto class="text-sm" {code} />
						</div>
					</div>
